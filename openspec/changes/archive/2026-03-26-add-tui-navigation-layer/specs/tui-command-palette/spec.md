...
Provide a unified, searchable entry point for navigating to any window/pane within the orc tmux session. The palette is strictly a navigation and read-only action surface — it never sends input to agent panes or performs destructive operations.
